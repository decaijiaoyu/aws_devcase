package com.awspaas.user.apps.devcase.metroskins;
...
public class MetroSkinsDemo extends AbstPortalSkins implements PortalSkinsInterface {

    @Override
    public String getHomePage(UserContext userContext) {
        StringBuilder sb = new StringBuilder();
        // 取当前用户可访问的全部功能。实际场景建议用getNavList逐级读取
        JSONArray navTree = SDK.getPortalAPI().queryNavTree(userContext);
        ...
        // user info
        String userInfo = userContext.getUserName();
        // template merge
        ...
        return HtmlPageTemplate.merge("com.awspaas.user.apps.devcase", "metro-index.html", macroLibraries);
    }
